...
1. Ensure you have the required prerequeisites installed:
    ...
    - [Google Chrome](https://www.google.com/chrome/) (v80 or higher)
...
Now you should be able to change Trydent code and see the changes instantly reflected in your browser!

## Documentation for Consideration
Trydent is a tool aimed to provide a better experience for developers in creating E2E tests. Therefore, it is recommended to familiarize yourself with the [Trydent documentation](./chrome-overview).
