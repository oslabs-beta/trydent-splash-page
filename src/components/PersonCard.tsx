...
const PersonCard: React.FC = (props) =>{
  ...
  return(
    ...
    <li className='bg-gray-300 bg-opacity-20 rounded-lg shadow-lg backdrop-blur-sm border border-white border-opacity-30 p-6 flex flex-col space-y-1 items-center list-none'>
      ...
      <ul className='flex'>
        <li className='mr-5'><a href={linkedinURL}> 
