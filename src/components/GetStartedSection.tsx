...
const GetStartedSection:React.FC = () =>{
  ...
  return (
    ...
    <section className='text-center p-10 flex flex-col items-center' style={{ background: 'radial-gradient(at -800% -400%, #f6f6f6, #072854)' }}>
      ...
      <p className="text-lg text-gray-300 mb-5 w-1/2">Start building out your testing suite by adding our DevTool to your browser. You'll find building tests for your App's user journeys much easier to create. </p>
