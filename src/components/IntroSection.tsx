  ...
  return (
    <>
      <section className="p-10 mt-10 grid lg:grid-cols-2 lg:gap-2 place-items-center " style={{ background: 'radial-gradient(at -800% -400%, #f6f6f6, #072854)' }}>
        ...
        >
          <img src={gif}
            className={`rounded-lg scale-75 transition duration-300 ease-in-out transform cursor-pointer  ${isClicked ? 'sm: scale-50  lg:scale-75 shadow-lg border border-white' : 'hover:scale-105'}`}
            onClick={handleClick}
          />
        </div>
      </section>
