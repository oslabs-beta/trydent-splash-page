...
const IntroSection:React.FC = () =>{
  ...
  return (
    <>
      <section className="p-5 grid md:grid-cols-2 md:gap-2 place-items-center" style={{ background: 'radial-gradient(at 50% 0%, #242424, blue)' }}>
        <article className="text-center mb-4">
          <h1 className="text-3xl font-bold mb-4">Tame your testing</h1>
          <p className="mb-4 text-lg">Trydent is a Chrome DevTool that enables you to save time on your end-to-end tests by autogenerating Cypress code.</p>
